...
static const double r2o_n[9] = {
    ...
    -4.3839511319450e+00, -2.8408632460772e-01,  2.1268463753307e-02
};
...
static const double r2r_n[43] = {
    ...
    -3.2277677238570e-05, -1.5033924542148e-03, -4.0668253562649e-02,
    ...
    -3.8946842435739e-02,  1.1256211360459e-11, -8.2311340897998e+00,
     1.9809712802088e-08,  1.0406965210174e-19, -1.0234747095929e-13,
    -1.0018179379511e-09, -8.0882908646985e-11,  1.0693031879409e-01,
    -3.3662250574171e-01,  8.9185845355421e-25,  3.0629316876232e-13,
...
double IAPWS_IF97::mu_liquid(double T_K, double /*rho*/) {
    // Vogel equation for water viscosity (273-623 K): mu = A * 10^(B/(T-C))
